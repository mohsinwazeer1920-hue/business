...
<body>
   <section id="header">
      <a href="<?php echo home_url(); ?>"><img src="<?php echo get_template_directory_uri(); ?>/beginner/assets/img/logos/logo.png"></a>
         ...
         <ul id="navbar">
            ...
            <li><a class="<?php if (is_page('shop'))
               echo 'active'; ?>" href="<?php echo site_url('/shop'); ?>">Shop</a>
                     ...
                     <li>
            <a class="<?php if (is_home() && !is_front_page()) echo 'active'; ?>" 
